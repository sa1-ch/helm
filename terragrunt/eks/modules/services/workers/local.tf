locals {
  ...
  cluster_primary_security_group_id = var.cluster_version >= 1.14 ? element(concat([var.cluster_security_group_id], list("")), 0) : null
  cluster_security_group_id         = var.cluster_create_security_group ? join("", [var.cluster_security_group_id]) : var.cluster_security_group_id
