...
from preprocessor_dependencies import CombinedAttributesAdder
...
if __name__ == '__main__':
    ...
    concat_data.columns = [i.strip() for i in concat_data.columns]
    concat_data=concat_data[feature_columns_names + [label_column]]
    concat_data=concat_data.astype(merge_two_dicts(feature_columns_dtype, label_column_dtype))'''
